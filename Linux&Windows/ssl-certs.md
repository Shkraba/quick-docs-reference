...
#### Example: 
Generate SSL Certificate on Windows 11
...
update-ca-trust
```
wiki page  [click here](https://wiki.archlinux.org/title/User:Grawity/Adding_a_trusted_CA_certificate)


Also you can use online tool [click here](https://decoder.link/converter)
